  ...
  return (
    ...
    >
      {Object.entries(
        ...
        >
          <div className="flex">
            <h1 className="rounded-lg bg-background px-2 py-1 text-xl font-black">
              {!isEuropeMap ? continent : null}
            </h1>
          </div>
          ...
          {Object.entries(
            ...
            <div key={country}>
              <div className="flex text-lg font-black">
                <h2 className={!isEuropeMap ? "pl-3" : ""}>{country}</h2>
              </div>
              {!isEuropeMap
                ? null
                : filteredDataCountry
